	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult37 = (float2(_BorderThickness , 0.0));
				float2 texCoord36 = IN.texCoord0.xy * float2( 1,1 ) + appendResult37;
				float2 appendResult41 = (float2(-_BorderThickness , 0.0));
				float2 texCoord40 = IN.texCoord0.xy * float2( 1,1 ) + appendResult41;
				float2 appendResult53 = (float2(0.0 , _BorderThickness));
				float2 texCoord56 = IN.texCoord0.xy * float2( 1,1 ) + appendResult53;
				float2 appendResult54 = (float2(0.0 , -_BorderThickness));
				...
				float4 Color = ( Colour18 + ( ( clampResult46 - tex2DNode29.a ) * _BorderColour ) );
...
/*ASEBEGIN
Version=18935
7.2;80.8;1333.4;766.2;2252.89;912.9095;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;25;-2397.528,416.0526;Inherit;False;Property;_BorderThickness;BorderThickness;4;0;Create;True;0;0;0;False;0;False;0.05;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;28;-1943.014,-610.9124;Inherit;True;Property;_MainTex;MainTex;2;0;Create;True;0;0;0;False;0;False;None;e0fe4a96c10ab2b44bab3bdd1f84fb4a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;10;-1031.46,-603.3496;Inherit;False;Property;_Color;Color;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1095.19,-193.26;Inherit;False;Property;_Alpha;Alpha;0;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;49;-584.501,394.9118;Inherit;False;Property;_BorderColour;BorderColour;3;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;8;-490.7015,21.59828;Inherit;False;18;Colour;1;0;OBJECT;;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;50;-116.7421,227.9699;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=3A2833F156A2971C197B3B05C69370BA7C484A26